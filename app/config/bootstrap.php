...
// Sessions are used for authentication (e.g. $_SESSION['user_id']).
// Start the session before any output so cookies/headers can be sent.
...
// This project currently uses several non-namespaced classes in app/ (e.g. AuthController,
// UserRepository, Validator). Ensure they're loaded for routes and AJAX validators.
require_once(__DIR__ . $ds . '..' . $ds . 'repository' . $ds . 'UserRepository.php');
require_once(__DIR__ . $ds . '..' . $ds . 'repository' . $ds . 'MessageRepository.php');
require_once(__DIR__ . $ds . '..' . $ds . 'services' . $ds . 'UserService.php');
require_once(__DIR__ . $ds . '..' . $ds . 'services' . $ds . 'validator.php');
require_once(__DIR__ . $ds . '..' . $ds . 'controllers' . $ds . 'AuthController.php');
require_once(__DIR__ . $ds . '..' . $ds . 'controllers' . $ds . 'MessageApiController.php');
require_once(__DIR__ . $ds . '..' . $ds . 'controllers' . $ds . 'UserApiController.php');
